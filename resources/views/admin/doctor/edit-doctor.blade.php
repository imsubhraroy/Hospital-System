                            ...
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="speciality" name="speciality"
                                        ...
                                        <option value="Heart" @if ($doctor->specialist == 'Heart') @selected(true) @endif>
                                            Heart</option>
                                        <option value="ENT" @if ($doctor->specialist == 'ENT') @selected(true) @endif>
                                            ENT</option>
                                        <option value="GeneralPhysician"
                                            @if ($doctor->specialist == 'GeneralPhysician') @selected(true) @endif>General Physician
                                        </option>
                                        <option value="Dentist"
                                            @if ($doctor->specialist == 'Dentist') @selected(true) @endif>Dentist</option>
                                    </select>
                                </div>
                                <div>
                                    <label for="room"
