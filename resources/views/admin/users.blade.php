                                    ...
                                    <thead
                                        ...
                                        <tr>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-left text-white">Id</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-left text-white">Name</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center text-white">Email</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center text-white">Phone</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center text-white">Address</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center text-white">Type</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                            ...
                                            <tr>
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="font-medium text-gray-300">{{ $users->id }}
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="font-medium text-gray-300">{{ $users->name }}
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="p-2 whitespace-nowrap">
                                                ...
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class=" text-center text-gray-300">
                                                        {{ $users->created_at }}</div>
                                                </td>

                                                <td class="p-2 whitespace-nowrap">
                                                    <div class=" text-center text-red-500"><a
                                                            href="{{ url('delete-user/' . $users->id) }}"
                                                            style="text-decoration: none;"
                                                            onclick="return confirm('are you to delete the user')"><i class="fa-sharp fa-solid fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
