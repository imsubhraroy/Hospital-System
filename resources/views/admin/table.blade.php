<div class="col-span-full xl:col-span-12 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100">Approve</h2>
    </header>
    <div class="p-3">
        ...
        <div
                        ...
                        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                            <h2 class="font-semibold text-slate-800 dark:text-slate-100">Appointments</h2>
                        </header>
                        <div class="p-3">
                            ...
                            <div class="overflow-x-auto">
                                <table class="table-auto w-full">
                                    ...
                                    <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
                                        ...
                                        @foreach ($approvedAppointment as $appointments)
                                            <tr>
