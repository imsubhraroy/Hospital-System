    ...
    <div
        ...
        <div class="px-5 pt-5 pb-5">
            ...
            <h2 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Total Appointments</h2>
            <div class="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase mb-1">Today</div>
            <div class="flex items-start">
